/**
 * Strategy (стратегия) - поведенческий паттерн, который определяет схожие алгоритмы и помещает
 * каждый в отдельный класс, после чего между этими алгоритмами можно автоматически переключаться
